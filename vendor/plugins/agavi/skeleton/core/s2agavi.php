 ...
 * @copyright (c) authors
 * @since     0.9.0
 * @version   $Id: agavi.php 317 2005-11-29 08:28:59Z bob $
 */
...
try {
	...
	if(!defined('AG_APP_DIR')) {
		define('AG_APP_DIR', dirname(@@AG_APP_DIR@@));
	}
	...
	require_once(AG_WEBAPP_DIR . '/lib/s2agavi/TraversalAutoloadConfigHandler.class.php');
